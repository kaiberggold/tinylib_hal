...
void hal::HalUsart::init(const std::uint32_t baud_rate)
{
  ...
  hal::HalRegAccess<std::uint8_t, std::uint8_t, hal::UBRR0L>::set_reg(ul);
  hal::HalRegAccess<std::uint8_t, std::uint8_t, hal::UBRR0H>::set_reg(uh);

  const std::uint8_t U2X0 = 1;
  hal::HalRegAccess<std::uint8_t, std::uint8_t, hal::UCSR0A>::reg_and(
      (1 << U2X0));
  hal::HalRegAccess<std::uint8_t, std::uint8_t, hal::UCSR0B>::set_bits(
      hal::TXEN0, hal::RXEN0);
  hal::HalRegAccess<std::uint8_t, std::uint8_t, hal::UCSR0C>::set_bits(
